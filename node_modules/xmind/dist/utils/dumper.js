...
class Dumper {
    constructor(options = {}) {
        ...
        if (!(options.workbook instanceof workbook_1.Workbook)) {
     ...
     */
    updateManifestMetadata(key, content, creator) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!key)
                throw new Error('key is empty');
            const [folderName, fileName] = key.split('/');
            yield creator.folder(folderName);
            yield creator.file(fileName, content);
     ...
     */
    get metadata() {
        return this.wrap(constants_1.PACKAGE_MAP.METADATA.NAME, '{}');
    }
    /**
     * @description manifest.json
     */
    get manifest() {
        return this.wrap(constants_1.PACKAGE_MAP.MANIFEST.NAME, JSON.stringify(this._manifest));
    }
    /**
    ...
    get json() {
        ...
        return this.wrap(constants_1.PACKAGE_MAP.CONTENT_JSON.NAME, value);
    }
    /**
     * @description content.xml
     */
    get xml() {
        return this.wrap(constants_1.PACKAGE_MAP.CONTENT_XML.NAME, XMLContents);
    }
}
