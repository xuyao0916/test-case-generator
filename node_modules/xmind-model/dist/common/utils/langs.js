...
exports.default = {
    translate(langType, key) {
        ...
        if (!lang) {
            ...
            if (!result) {
                config_1.defaultConfig.get(constants_1.CONFIG.LOGGER).warn(`word '${key}' of language '${langType}' hasn't been translated`);
                return key;
            }
            else {
                return result;
